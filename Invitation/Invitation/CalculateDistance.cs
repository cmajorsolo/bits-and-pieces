...
namespace Invitation
{
    public class CalculateDistance:ICalculate
    {
        ...
        {
            double p1LatitudeInRadiance = Utilities.ConvertDegreeToRadiance(p1Latitude);
            double p1LongitudeInRadiance = Utilities.ConvertDegreeToRadiance(p1Longitude);
            double p2LatitudeInRadiance = Utilities.ConvertDegreeToRadiance(p2Latitude);
            double p2LongitudeInRadiance = Utilities.ConvertDegreeToRadiance(p2Longitude);
